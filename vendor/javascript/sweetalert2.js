// sweetalert2@11.21.2 downloaded from https://ga.jspm.io/npm:sweetalert2@11.21.2/dist/sweetalert2.all.js
...
/**
   * @returns {boolean}
   */const xe=()=>{const e=$();if(!e)return false;e.remove();ae([document.documentElement,document.body],[w["no-backdrop"],w["toast-shown"],w["has-column"]]);return true};const Ce=()=>{i.currentInstance.resetValidationMessage()};const Ae=()=>{const e=S();const t=re(e,w.input);const o=re(e,w.file);
...
/**
   * @param {SweetAlertOptions} params
   */;const $e=e=>{const t=S();t.setAttribute("role",e.toast?"alert":"dialog");t.setAttribute("aria-live",e.toast?"polite":"assertive");e.toast||t.setAttribute("aria-modal","true")};
/**
...
/**
   ...
   */const Se=(e,t)=>{e instanceof HTMLElement?t.appendChild(e):typeof e==="object"?Pe(e,t):e&&J(t,e)};
/**
   * @param {any} param
   * @param {HTMLElement} target
   */const Pe=(e,t)=>{e.jquery?Te(t,e):J(t,e.toString())};
/**
   * @param {HTMLElement} target
   * @param {any} elem
...
/**
   ...
   */function ze(e){const t=window.getComputedStyle(e);const o=t.backgroundColor.replace(/rgba?\((\d+), (\d+), (\d+).*/,"rgba($1, $2, $3, 0.5)");e.style.setProperty("--swal2-action-button-outline",t.getPropertyValue("--swal2-outline").replace(/ rgba\(.*/,` ${o}`))}
/**
   * @param {HTMLElement} button
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */const Re=(e,t)=>{const o=S();if(!o)return;const n=_e.innerParams.get(e);const s=!n||t.input!==n.input;Fe.forEach((e=>{const n=re(o,w[e]);if(n){We(e,t.inputAttributes);n.className=w[e];s&&ce(n)}}));if(t.input){s&&Ue(t);Ze(t)}};
/**
   * @param {SweetAlertOptions} params
...
/**
   ...
   */const We=(e,t)=>{const o=S();if(!o)return;const n=te(o,e);if(n){Ye(n);for(const e in t)n.setAttribute(e,t[e])}};
/**
   * @param {SweetAlertOptions} params
...
/**
   ...
   * @returns {HTMLElement | undefined}
   */const Je=e=>{const t=S();if(t)return re(t,w[/** @type {SwalClass} */e]||w.input)};
/**
...
/**
   ...
   * @param {SweetAlertOptions} params
   * @returns {HTMLInputElement}
   */Qe.checkbox=(e,t)=>{const o=te(S(),"checkbox");o.value="1";o.checked=Boolean(t.inputValue);const n=e.querySelector("span");J(n,t.inputPlaceholder||t.inputLabel);return o};
/**
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */const et=(e,t)=>{const o=j();if(o){de(o);ee(o,t,"htmlContainer");if(t.html){Se(t.html,o);le(o,"block")}else if(t.text){o.textContent=t.text;le(o,"block")}else ce(o);Re(e,t)}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */const tt=(e,t)=>{const o=F();if(o){de(o);we(o,t.footer,"block");t.footer&&Se(t.footer,o);ee(o,t,"footer")}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
...
/**
   ...
   * @param {SweetAlertOptions} params
   */const nt=(e,t)=>{for(const[o,n]of Object.entries(p))t.icon!==o&&ae(e,n);se(e,t.icon&&p[t.icon]);lt(e,t);st();ee(e,t,"icon")};const st=()=>{const e=S();if(!e)return;const t=window.getComputedStyle(e).getPropertyValue("background-color");
...
/**
   ...
   */const bt=e=>{const t=S();if(e.target===t||P().contains(/** @type {HTMLElement} */e.target)){ut=true;const o=kt(e);wt=o.clientX;mt=o.clientY;pt=parseInt(t.style.insetInlineStart)||0;ht=parseInt(t.style.insetBlockStart)||0;se(t,"swal2-dragging")}};
/**
   * @param {MouseEvent | TouchEvent} event
   */const vt=e=>{const t=S();if(ut){let{clientX:o,clientY:n}=kt(e);t.style.insetInlineStart=`${pt+(o-wt)}px`;t.style.insetBlockStart=`${ht+(n-mt)}px`}};const yt=()=>{const e=S();ut=false;ae(e,"swal2-dragging")};
/**
   * @param {MouseEvent | TouchEvent} event
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */const Bt=(e,t)=>{const o=O();if(o){de(o);we(o,t.title||t.titleText,"block");t.title&&Se(t.title,o);t.titleText&&(o.innerText=t.titleText);ee(o,t,"title")}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */const Lt=(e,t)=>{xt(e,t);qe(e,t);At(e,t);ot(e,t);dt(e,t);Bt(e,t);Ie(e,t);et(e,t);Oe(e,t);tt(e,t);const o=S();typeof t.didRender==="function"&&o&&t.didRender(o);i.eventEmitter.emit("didRender",o)};const St=()=>me(S());const Pt=()=>{var e;return(e=I())===null||e===void 0?void 0:e.click()};const Tt=()=>{var e;return(e=D())===null||e===void 0?void 0:e.click()};const Ot=()=>{var e;return(e=q())===null||e===void 0?void 0:e.click()};
...
/**
   ...
   * @param {*} dismissWith
   */const zt=(e,t,o)=>{Mt(e);if(!t.toast){e.keydownHandler=e=>Dt(t,e,o);e.keydownTarget=t.keydownListenerCapture?window:S();e.keydownListenerCapture=t.keydownListenerCapture;e.keydownTarget.addEventListener("keydown",e.keydownHandler,{capture:e.keydownListenerCapture});e.keydownHandlerAdded=true}};
/**
   * @param {number} index
   * @param {number} increment
   */const Ht=(e,t)=>{var o;const n=W();if(n.length){e+=t;e===-2&&(e=n.length-1);e===n.length?e=0:e===-1&&(e=n.length-1);n[e].focus()}else(o=S())===null||o===void 0||o.focus()};const It=["ArrowRight","ArrowDown"];const qt=["ArrowLeft","ArrowUp"];
/**
   * @param {SweetAlertOptions} innerParams
...
/**
   * @param {KeyboardEvent} event
   * @param {SweetAlertOptions} innerParams
   */const Vt=(e,t)=>{if(!x(t.allowEnterKey))return;const o=te(S(),t.input);if(e.target&&o&&e.target instanceof HTMLElement&&e.target.outerHTML===o.outerHTML){if(["textarea","file"].includes(t.input))return;Pt();e.preventDefault()}};
/**
   * @param {KeyboardEvent} event
...
/**
   ...
   */const ho=e=>{let t=S();t||new gs;t=S();if(!t)return;const o=N();K()?ce(P()):go(t,e);le(o);t.setAttribute("data-loading","true");t.setAttribute("aria-busy","true");t.focus()};
/**
   * @param {HTMLElement} popup
   * @param {HTMLButtonElement | null} [buttonToReplace]
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */;const xo=(e,t)=>{const o=S();if(!o)return;
/**
...
/**
   * @param {SweetAlert} instance
   */const So=e=>{const t=_e.innerParams.get(e);e.disableButtons();t.returnInputValueOnDeny?To(e,"deny"):jo(e,false)};
/**
   * @param {SweetAlert} instance
   * @param {Function} dismissWith
   */const Po=(e,t)=>{e.disableButtons();t(jt.cancel)};
/**
   * @param {SweetAlert} instance
...
/**
   ...
   * @param {SweetAlert} instance
   * @param {any} value
   */const Ho=(e,t)=>{const o=_e.innerParams.get(e||void 0);o.showLoaderOnConfirm&&ho();if(o.preConfirm){e.resetValidationMessage();e.isAwaitingPromise=true;const n=Promise.resolve().then((()=>A(o.preConfirm(t,o.validationMessage))));n.then((o=>{if(me(H())||o===false){e.hideLoading();co(e)}else Mo(e,typeof o==="undefined"?t:o)})).catch((t=>zo(e||void 0,t)))}else Mo(e,t)};function Io(){const t=_e.innerParams.get(this||e);if(!t)return;const o=_e.domCache.get(this||e);ce(o.loader);K()?t.icon&&le(P()):qo(o);ae([o.popup,o.actions],w.loading);o.popup.removeAttribute("aria-busy");o.popup.removeAttribute("data-loading");o.confirmButton.disabled=false;o.denyButton.disabled=false;o.cancelButton.disabled=false}const qo=e=>{const t=e.popup.getElementsByClassName(e.loader.getAttribute("data-button-to-replace"));t.length?le(t[0],"inline-block"):pe()&&ce(e.actions)};
/**
...
/**
   ...
   * @param {boolean} disabled
   */function No(e,t){const o=S();if(o&&e)if(e.type==="radio"){
...
/**
   ...
   * @param {number} ms
   * @returns {number | undefined}
   */const Sn=e=>{if(i.timeout){const t=i.timeout.increase(e);be(t,true);return t}};
/**
   ...
   *
   * @returns {boolean}
   */const Pn=()=>!!(i.timeout&&i.timeout.isRunning());let Tn=false;const On={};
/**
   * @param {string} attr
...
/**
   * @param {string} [eventName]
   * @param {EventHandler} [eventHandler]
   */const In=(e,t)=>{e?t?i.eventEmitter.removeListener(e,t):i.eventEmitter.removeAllListeners(e):i.eventEmitter.reset()};var qn=Object.freeze({__proto__:null,argsToParams:xn,bindClickHandler:jn,clickCancel:Ot,clickConfirm:Pt,clickDeny:Tt,enableLoading:ho,fire:Cn,getActions:_,getCancelButton:q,getCloseButton:U,getConfirmButton:I,getContainer:$,getDenyButton:D,getFocusableElements:W,getFooter:F,getHtmlContainer:j,getIcon:P,getIconContent:T,getImage:M,getInputLabel:V,getLoader:N,getPopup:S,getProgressSteps:z,getTimerLeft:En,getTimerProgressBar:R,getTitle:O,getValidationMessage:H,increaseTimer:Sn,isDeprecatedParameter:en,isLoading:X,isTimerRunning:Pn,isUpdatableParameter:Qo,isValidParameter:Go,isVisible:St,mixin:An,off:In,on:zn,once:Hn,resumeTimer:Bn,showLoading:ho,stopTimer:$n,toggleTimer:Ln});class Timer{
/**
...
/**
       ...
       */
const a=t=>{e.close({isDismissed:true,dismiss:t})};Rt.swalPromiseResolve.set(e,n);Rt.swalPromiseReject.set(e,s);t.confirmButton.onclick=()=>{Lo(e)};t.denyButton.onclick=()=>{So(e)};t.cancelButton.onclick=()=>{Po(e,a)};t.closeButton.onclick=()=>{a(jt.close)};mn(o,t,a);zt(i,o,a);fo(e,o);Jn(o);us(i,o,a);ws(t,o);setTimeout((()=>{t.container.scrollTop=0}))}));
/**
...
/**
   * @param {SweetAlert} instance
   * @returns {DomCache}
   */const ds=e=>{const t={popup:S(),container:$(),actions:_(),confirmButton:I(),denyButton:D(),cancelButton:q(),loader:N(),closeButton:U(),validationMessage:H(),progressSteps:z()};_e.domCache.set(e,t);return t};
/**
   * @param {GlobalState} globalState
   * @param {SweetAlertOptions} innerParams
   * @param {Function} dismissWith
